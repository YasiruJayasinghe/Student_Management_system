...
<body>
   <nav>
    <label class="logo">Wishwa Education Academy</label>
    <ul>
        <li><a href="">Home</a></li>
   ...
   <div class="section1">
   	...
   	<img src= "school_management.jpg" class="main_img">
   </div>
   ...
   <div class="container">
   	<div class="row">
   		...
   		<div class="col-md-8">
   			<h1>Welcome to Wishwa Education Academy </h1>
   			<p>MEMS has been committed to global learning long before it became an indispensable feature of contemporary education. Established in 1997, we proudly stand as the 1st English medium school in Sri Lanka to adopt both Pearson Edexcel and Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.MEMS has been committed to global learning long before it became an indispensable feature of contemporary education. Established in 1997, we proudly stand as the 1st English medium school in Sri Lanka to adopt both Pearson Edexcel and Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.</p>
   		</div> 		
   	</div>  	
   </div>
